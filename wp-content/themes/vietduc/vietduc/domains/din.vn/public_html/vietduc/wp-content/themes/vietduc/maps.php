...
<body>
<div id="map9505" style="width:939px; height:382px;"></div>
<script type="text/javascript">
    ...
    function initialize() {
        setTimeout(function() {
            var locations = [[<?php print $latitude; ?>,<?php print $longitude; ?>],];

            var map = new google.maps.Map(document.getElementById('map9505'), {
                zoom: 10,
